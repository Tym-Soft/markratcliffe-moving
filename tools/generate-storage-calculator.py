...
<head>
  ...
  <link href="../css/new-pages.css?v=20260623" rel="stylesheet">
        ...
        <div class="quote-card quote-card-full" aria-live="polite" aria-label="Live estimate">
          ...
          <aside class="qc-inv-prompt" id="inventory-prompt" hidden>
            ...
            <div class="qc-inv-prompt-actions">
              ...
              <button type="button" id="add-inventory-manually" class="qc-inv-manual">Add manually</button>
...
{panels_html}
          ...
          <div class="qc-inventory-summary" id="inventory-summary" hidden>
            <div class="qc-inventory-summary-header">
...
__BED_INVENTORY__
  ...
  <script defer src="../js/storage-calculator.js?v=20260623"></script>
</body>
</html>
"""

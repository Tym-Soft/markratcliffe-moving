...
<head>
  ...
  <link href="../css/new-pages.css?v=20260580" rel="stylesheet">
    ...
    <div class="np-inner">
      ...
      <div class="calc-shell">
        ...
        <div class="calc-shell-inputs">
          ...
          <!-- Removals-only mode: hide the storage toggle (no storage in this mode) -->
          <label class="storage-toggle" data-show-modes="removals">
            <input type="checkbox" id="storage-enabled">
            <span>Add storage? (Switch the mode above to &ldquo;Both&rdquo;.)</span>
          </label>
...
__BED_INVENTORY__
  ...
  <script defer src="../js/storage-calculator.js?v=20260580"></script>
</body>
</html>
"""

          ...
          <fieldset class="qc-step" id="bedroom-selector">
            ...
            <div class="qc-bed-row">
              <label class="qc-bed-card">
                ...
                <span class="qc-bed-text"><strong>1-bed</strong><small>from 100 cu ft</small></span>
              </label>
              <label class="qc-bed-card">
    ...
    <div class="np-inner">
      ...
      <table class="rate-table">
        <thead>
          <tr>
            <th>Vehicle</th>
            <th>Auto-picked when</th>
            <th>Base charge</th>
            <th>Each cu ft above 500</th>
            <th>£ / mile</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            <td><strong>7.5 Tonne Lorry</strong></td>
            <td>801 – 1,500 cu ft</td>
            <td>£2.75</td>
          </tr>
          <tr>
            <td><strong>18 Tonne Lorry</strong></td>
            <td>1,501 – 2,500 cu ft</td>
            <td>£4.00</td>
          </tr>
          <tr>
...
__BED_INVENTORY__
  ...
  <script defer src="../js/storage-calculator.js?v=20260596"></script>
</body>
</html>
"""

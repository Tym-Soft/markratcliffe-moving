    ...
    <div class="np-inner">
      ...
      <div class="cost-estimator" id="cost-estimator">
        ...
        <div class="cost-output" aria-live="polite">
          ...
          <div class="cost-line"><span>Volume cost</span><strong id="cost-volume">£0</strong></div>
          <div class="cost-line"><span>Mileage</span><strong id="cost-mileage">£0</strong></div>
          <div class="cost-line"><span>Minimum charge</span><strong id="cost-minimum">£0</strong></div>
          <div class="cost-line cost-total"><span>Estimated total</span><strong id="cost-total">£0</strong></div>
        </div>
      </div>

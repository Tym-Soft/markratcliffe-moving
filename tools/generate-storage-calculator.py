          ...
          <fieldset class="qc-step" id="bedroom-selector">
            ...
            <div class="qc-bed-row">
              <label class="qc-bed-card">
                ...
                <span class="qc-bed-text"><strong>1-bed</strong><small>£500 base · 100 cu ft</small></span>
              </label>
              <label class="qc-bed-card">
...
{panels_html}
  ...
  <section class="np-section np-section-soft">
    <div class="np-inner">
      ...
      <p>Each property type carries its own base charge that covers the typical volume for that home. Every cu ft above the property's typical adds <strong>£1.21</strong>. Mileage is added at the per-vehicle rate (vehicle is auto-picked from the volume you enter). All prices below are <em>nett</em> — 20% VAT is added to the final quote.</p>
      <table class="rate-table">
        ...
        <tbody>
          <tr><td><strong>1-bed</strong> flat or studio</td><td><strong>£500</strong></td><td>first 100 cu ft</td><td>£1.21</td></tr>
          <tr><td><strong>2-bed</strong> home</td><td><strong>£650</strong></td><td>first 800 cu ft</td><td>£1.21</td></tr>
          <tr><td><strong>3-bed</strong> home</td><td><strong>£900</strong></td><td>first 1,200 cu ft</td><td>£1.21</td></tr>
          <tr><td><strong>4-bed</strong> home</td><td><strong>£1,500</strong></td><td>first 1,800 cu ft</td><td>£1.21</td></tr>
          <tr><td><strong>5+ bed</strong> / antiques / country</td><td><strong>£2,500</strong></td><td>first 2,800 cu ft</td><td>£1.21</td></tr>
        </tbody>
      </table>
...
__BED_INVENTORY__
  ...
  <script defer src="../js/storage-calculator.js?v=20260599"></script>
</body>
</html>
"""
